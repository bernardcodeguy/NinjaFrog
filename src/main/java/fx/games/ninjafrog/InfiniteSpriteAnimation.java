...
public class InfiniteSpriteAnimation extends AnimationTimer {
    ...
    public InfiniteSpriteAnimation(ImageView imageView, int columns, int rows, int totalFrames, int frameWidth, int frameHeight, float framesPerSecond) {
